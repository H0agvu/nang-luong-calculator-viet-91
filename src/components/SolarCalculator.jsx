...
import { inverters as defaultInverters } from "@/data/solarData";
...
const SolarCalculator = () => {
  ...
  const [inverterCombination, setInverterCombination] = useState(null);
  const [dcAcRatio, setDcAcRatio] = useState(0);
