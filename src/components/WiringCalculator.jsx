...
const WiringCalculator = ({ inverterCombination }) => {
  // Thiết lập cho inverter đơn lẻ
  const [singlePhaseType, setSinglePhaseType] = useState("3P");
  const [singleCoreType, setSingleCoreType] = useState("multi");
  const [singleInsulationType, setSingleInsulationType] = useState("XLPE");
  const [singleInstallationType, setSingleInstallationType] = useState("air");
  // Thiết lập cho tủ tổng
  const [totalPhaseType, setTotalPhaseType] = useState("3P");
  const [totalCoreType, setTotalCoreType] = useState("multi");
  const [totalInsulationType, setTotalInsulationType] = useState("XLPE");
  const [totalInstallationType, setTotalInstallationType] = useState("air");

  const [inverterWiring, setInverterWiring] = useState([]);
  const [totalWiring, setTotalWiring] = useState(null);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) => setSinglePhaseType(value)}
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) => setSingleCoreType(value)}
                    className="flex space-x-4"
                  >
                    <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) => setSingleInsulationType(value)}
                    className="flex space-x-4"
                  >
                    <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) => setSingleInstallationType(value)}
                    className="flex space-x-4"
                  >
                    <div className="flex items-center space-x-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) => setTotalPhaseType(value)}
                    className="flex space-x-4"
                  >
                    <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    value={totalCoreType}
                    onValueChange={(value) => setTotalCoreType(value)}
                    className="flex space-x-4"
                  >
                    <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) => setTotalInsulationType(value)}
                    className="flex space-x-4"
                  >
                    <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(value) => setTotalInstallationType(value)}
                    className="flex space-x-4"
                  >
                    <div className="flex items-center space-x-2">
